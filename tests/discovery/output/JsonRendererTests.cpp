...
void rendersSingleAsset()
{
    ...
    expect(contains(output, "\"display_name\": \"Nam Laptop\""), "JSON should contain display name");
    expect(contains(output, "\"vendor\": \"Apple\""), "JSON should contain vendor");
    expect(contains(output, "\"os_hint\": \"macos\""), "JSON should contain OS hint");
    expect(contains(output, "\"device_type\": \"computer\""), "JSON should contain device type");
    expect(contains(output, "\"model_hint\": \"MacBook\""), "JSON should contain model hint");
